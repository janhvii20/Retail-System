    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <FilterBar
          filters={filters}
          filterOptions={filterOptions}
          onFilterChange={(name, value) => setFilters(p => ({ ...p, [name]: value }))}
          sort={sort}
          onSortChange={setSort}
          onRefresh={() => fetchTransactions(buildQueryParams())}
        />
        ...
        <PaginationBar pagination={pagination} onPageChange={page => setPage(page)} />
      </div>
    </div>
  );
}
